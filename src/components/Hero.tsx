    ...
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2 ">
          <div className="mb-8">
          <h1 className="text-4xl font-bold tracking-tight lg:text-4xl xl:text-6xl">
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent inline-flex items-baseline">
                <span className="text-[2em] leading-none">Discover</span>
                <span className="ml-2">the cosmos!</span>
              </span>
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300 text-center max-w-3xl mx-auto">
            ...
            <div className="flex justify-center">
              ...
              <Link
                href="https://apps.apple.com/app/id6742095766"
                className="px-8 py-4"
              >
                <Image
